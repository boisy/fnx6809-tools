...
SplashText
               ldx       #Text2Display
               ldy       #IOADDR           ; Start of Text Buffer
SplashTextLoop
               lda       ,X+
               cmpa      #0x00
...
UpdateFONTSet
               ldx       #FONTSet
               ldy       #IOADDR           ; Start of FONT Buffer
FONTSet_Upload_Loop
               lda       ,X+
               sta       ,Y+
               cmpy      #IOADDR+0x800
...
RemoveMMUPage_FromSlot7 lda       #0x00               ; I am working off the MMU Page 0
               ...
               lda       #0x07
               sta       MAPSLOT             ; Putting Page $C0 in Slot 7 - 0xFFA8 - Slot 0, 0xFFAF - Slot 7
               rts
